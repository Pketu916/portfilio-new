            ...
            <Section id="why-choose-me" className="min-h-screen flex flex-col justify-center">
                ...
                <div className="hidden md:block w-full overflow-hidden">
                    <div ref={cardsWrapperRef} className="why-choose-card cards-wrapper !px-[5%] flex-nowrap">
                        {reasons.map((item, index) => (
                            ...
                            >
                                <div>
                                    <span className="text-xl font-bold text-color-primary-accessible block mb-4">0{index + 1}</span>
                ...
                <div className="block md:hidden w-full px-[5%] relative">
                        ...
                        {reasons.map((item, index) => (
                            <SwiperSlide key={`mobile-${index}`} className="h-auto pb-4">
                                <div className="card-item w-full h-[380px] p-6 flex flex-col justify-between bg-white card-shadow mx-auto">
                                    <div>
                                        <span className="text-xl font-bold text-color-primary-accessible block mb-3">0{index + 1}</span>
                    ...
                    <div className="flex justify-center items-center gap-4 mt-8">
                        <button type="button" aria-label="Show previous reason" className="swiper-button-prev-custom focus-ring w-12 h-12 flex items-center justify-center bg-white border-2 border-black button-shadow hover:bg-color-primary hover:text-on-primary transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                                <path d="m15 18-6-6 6-6" />
                            </svg>
                        </button>
                        <button type="button" aria-label="Show next reason" className="swiper-button-next-custom focus-ring w-12 h-12 flex items-center justify-center bg-white border-2 border-black button-shadow hover:bg-color-primary hover:text-on-primary transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
